        ...
        <div class="col-lg-8 col-lg-offset-2">
            ...
            <div class="cols">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <img class="img-rounded" src="/resources/img/hiber.png" alt="hibernate logo" width="140"
                             height="140">
                    ...
                    <div class="col-lg-4">
                        <img class="img-rounded" src="/resources/img/jpa.png" alt="hibernate logo" width="140"
                             height="140">
