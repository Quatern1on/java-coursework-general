...
import edu.javavt18.dao.jpa.CarBrandDAOJpaImpl;
import edu.javavt18.dao.jpa.CarModelDAOJpaImpl;
...
public class JpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactory.setPackagesToScan(new String[] {"edu.javavt18.model"});
